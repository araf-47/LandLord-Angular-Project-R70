...
export type NavIconName =
  ...
  | 'payments' | 'expenses' | 'ledger' | 'reports' | 'maintenance' | 'messages' | 'settings' | 'insights';
...
@Component({
  ...
  template: `
    @switch (name) {
      ...
      @case ('insights') {
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l1.9 4.9L19 9.8l-4.9 1.9L12 16.6l-1.9-4.9L5 9.8l4.9-1.9z" /><path d="M19 15l.8 2 2 .8-2 .8-.8 2-.8-2-2-.8 2-.8z" /></svg>
      }
    }
  `,
})
